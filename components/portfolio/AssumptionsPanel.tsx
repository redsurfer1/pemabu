...
export function AssumptionsPanel({ assumptions, onSave, isRecomputing }: AssumptionsPanelProps) {
  const [open, setOpen] = useState(false);
  const [local, setLocal] = useState<EngineAssumptions>(assumptions);
