  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-[10px] leading-relaxed" style={{ color: brand.inkLight }}>
        This report is generated by local automated logic from your portfolio aggregates. It does not
        constitute financial advice, investment recommendations, or regulated advisory services.
      </p>
