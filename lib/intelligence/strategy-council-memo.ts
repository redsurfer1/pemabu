 ...
 */
export async function generateMonthlyMemo(packet: InstitutionalMemoryV1): Promise<StrategyCouncilMemoPayload> {
  return generateStrategyCouncilMonthlyMemo(JSON.stringify(packet));
}
